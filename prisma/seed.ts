...
async function main() {
    ...
    const newsData = [
        { id: '1', title: 'Sierra Leone Set to Host West Africa Zonal Tournament', excerpt: 'The Sierra Leone Chess Federation has officially been awarded the hosting rights.', content: 'Freetown is preparing to welcome elite grandmasters...', date: '2025-06-12', author: 'Technical Committee', category: 'Tournament', image: 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?q=80&w=1000', readTime: '5 min read', tags: 'Championship,Freetown,International', featured: true },
        { id: '2', title: 'New Digital Rating System Launched for National Players', excerpt: 'SLCF introduces a blockchain-verified rating terminal.', content: 'In a significant move towards modernization...', date: '2025-06-10', author: 'IT Department', category: 'Federation', image: 'https://images.unsplash.com/photo-1586075010923-2cf457062149?q=80&w=1000', readTime: '3 min read', tags: 'Technology,Ratings,Digital Hub', featured: false }
    ]
